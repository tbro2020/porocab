    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "proof_of_id",
                    models.FileField(
                        upload_to="proof_of_id/", verbose_name="preuve d'identité"
                    ),
                ),
                (
                    "mobile_number",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_type",
                    core.models.fields.model_select_to_signle_field.ModelSelect2Single(
                        default=None,
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, verbose_name="authentification requise"
                    ),
                ),
                (
                    "title",
                    models.CharField(max_length=100, unique=True, verbose_name="titre"),
                ),
                (
                    "content",
                    tinymce.models.HTMLField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "national_id",
                    models.CharField(
                        max_length=100, verbose_name="identification nationale"
                    ),
                ),
                (
                    "commercial_register_number",
                    models.CharField(
                        max_length=100, verbose_name="numéro du registre du commerce"
                    ),
                ),
                (
                    "created_by",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        null=True, verbose_name="id de l'objet"
                    ),
                ),
                (
                    "action",
                    models.CharField(
                        choices=[("APPROVED", "approuvé"), ("REJECTED", "rejetée")],
                        default=None,
                        max_length=10,
                        null=True,
                        verbose_name="action",
